...
export default function Hondacivic(){
    return(
        ...
        <img src="/suzuki.png" alt="alto" height={200} width={200} className="border border-gray-900 py-5"/>
        </div>
        <div>
        ...
        <Link href="/forms">
        <button className=" text-center text-white bg-blue-600 py-3 px-3 hover:bg-red-600">Make Payment</button>
        </Link>
    </div>
    )
}